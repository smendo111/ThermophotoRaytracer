...
Sc.add_Camera(screen_width = 300 ,screen_height = 300, 
...
cb = Cuboid( material = blue_glass, center = vec3(200, 200, -300), width = 30,height = 165*6, length = 600, shadow = False)#182.5, 165, -285-160/2
cb.rotate(θ = 90, u = vec3(1,0,0))
cb.rotate(θ = 90, u = vec3(0,1,0))
cb.rotate(θ = 90, u = vec3(1,0,0))
Sc.add(cb)
